...
Route::domain(config('app.cms_domain'))->group(function () {
    ...
    Route::group(['middleware' => 'auth:admin'], function () {
        ...
        Route::get('/categories', 'App\Http\Controllers\cms\CategoryController@index')->name('cms.categories.index');
        Route::get('/category/show/{id}', 'App\Http\Controllers\cms\CategoryController@show')->name('cms.categories.show');
        Route::get('/category/create', 'App\Http\Controllers\cms\CategoryController@create')->name("cms.categories.create");
        Route::post('/category/store', 'App\Http\Controllers\cms\CategoryController@store')->name("cms.categories.store");
        Route::get('/category/delete/{id}', 'App\Http\Controllers\cms\CategoryController@delete')->name("cms.categories.delete");
        Route::get('/category/edit/{id}', 'App\Http\Controllers\cms\CategoryController@edit')->name("cms.categories.edit");
        Route::post('/category/update/{id}', 'App\Http\Controllers\cms\CategoryController@update')->name("cms.categories.update");
