                ...
                <div class="widget-header">
                    ...
                    <div class="row">
                        ...
                        <div
                            ...
                            <a href="{{ route('cms.categories.create') }}" name="txt"
                                                ...
                                                <div class="dropdown custom-dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink1">
                                                        <a class="dropdown-item"
                                                            href="{{ route('cms.categories.show', $category->id) }}">View</a>
                                                        <a class="dropdown-item"
                                                            href="{{ route('cms.categories.edit', $category->id) }}">Edit</a>
                                                        <a class="dropdown-item"
                                                            href="{{ route('cms.categories.delete', $category->id) }}"
