                ...
                <div class="widget-header">
                            ...
                            <nav class="breadcrumb-two" aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"><a
                                            href="javascript:void(0);">Data</a></li>
                                </ol>
                            </nav>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div
                            ...
                            @if (!$dataCount)
                                <a href="{{ route('cms.data.create') }}" name="txt" class="btn btn-primary mt-2 ml-3 ">
                                    Add New Data
                                </a>
                            @endif
                        </div>
                                                ...
                                                <div class="dropdown custom-dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink1">
                                                        <a class="dropdown-item"
                                                            href="{{ route('cms.data.edit', $data->id) }}">Edit</a>
                                                        <a class="dropdown-item"
                                                            href="{{ route('cms.data.delete', $data->id) }}"
                                                            onclick="return confirm('Are you sure you want delete this Data?');">Delete</a>
                                                    </div>
                                                </div>
