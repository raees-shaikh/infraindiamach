...
<head>
    ...
    <style>
        ...
        .body-bg {
            background: linear-gradient(180deg, #bd20328f 0%,#FDCF8C 100%); !important;
...
<body class="auth-page-bg body-bg">
    <div class="container">
        ...
        <div class="auth-form px-2 mx-auto" style="max-width:550px">
            <img class="d-block mx-auto w-100 mt-5" style="max-width:250px;border-radius:10px;background:white"
                src="frontend/logo.jpeg" alt="">
