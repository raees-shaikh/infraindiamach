...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{ asset('frontend/logo.jpeg') }}" />
    ...
    <style>
        .body-bg {
            background: linear-gradient(180deg, #bd20328f 0%,#FDCF8C 100%);
                    ...
                    <div class="form-content">
                        ...
                        <div class="row text-center">
                            <div class="col col-12">
                                <a href="/">
                                    <img class="d-block mx-auto " style="max-width:30%;border-radius:10px;background:white"
                                        src="{{ asset('frontend/logo.jpeg') }}" alt="">
                                </a>
                            </div>
