                ...
                <div class="widget-header">
                            ...
                            <nav class="breadcrumb-two" aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"><a
                                            href="javascript:void(0);">Offers</a></li>
                                </ol>
                            </nav>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div
                            ...
                            <a href="{{ route('cms.offer.create') }}" name="txt" class="btn btn-primary mt-2 ml-3 ">
                                Add New Offer
                            </a>
                        </div>
                                                ...
                                                <div class="dropdown custom-dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink1">
                                                        <a class="dropdown-item"
                                                            href="{{ route('cms.offer.show', $offer->id) }}">View</a>
                                                        <a class="dropdown-item"
                                                            href="{{ route('cms.offer.edit', $offer->id) }}">Edit</a>
                                                        <a class="dropdown-item"
                                                            href="{{ route('cms.offer.delete', $offer->id) }}"
                                                            onclick="return confirm('Are you sure you want delete this Offer?');">Delete</a>
                                                    </div>
                                                </div>
