                                            ...
                                            <td class="text-center">
                                                <div class="dropdown custom-dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink1">
                                                        ...
                                                        <a class="dropdown-item"
                                                            href="{{ route('cms.exhibition.media.index', $exhibition->id) }}">View
                                                            Gallery</a>
                                                        <a class="dropdown-item"
                                                            href="{{ route('cms.exhibition.delete', $exhibition->id) }}"
                                                            onclick="return confirm('Are you sure you want delete this Exhibition?');">Delete</a>
                                                    </div>
                                                </div>
