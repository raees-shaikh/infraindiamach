<link href="{{ url('frontend/logo.jpeg') }}" rel="shortcut icon" type="image/x-icon">
<link href="{{ url('frontend/logo.jpeg') }}" rel="apple-touch-icon" sizes="144x144">
<link href="{{ url('frontend/logo.jpeg') }}" rel="apple-touch-icon" sizes="114x114">
<link href="{{ url('frontend/logo.jpeg') }}" rel="apple-touch-icon" sizes="72x72">
<link href="{{ url('frontend/logo.jpeg') }}" rel="apple-touch-icon">
...
<link rel="shortcut icon" href="{{ asset('frontend/logo.jpeg') }}" type="image/x-icon">
<!-- END GLOBAL MANDATORY STYLES -->

<!-- BEGIN PAGE LEVEL PLUGINS/CUSTOM STYLES -->
<link href="backend/plugins/apex/apexcharts.css" rel="stylesheet" type="text/css">
<link href="backend/assets/css/dashboard/dash_2.css" rel="stylesheet" type="text/css" />
